...
public class PanelSewa extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        sewaBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sewaBtnActionPerformed(evt);
            }
        });

        nomorPolisiLabel.setText("--");

        brandLabel.setText("--");

        tipeLabel.setText("--");

        transmisiLabel.setText("--");

        tahunLabel.setText("--");

        silinderLabel.setText("--");
